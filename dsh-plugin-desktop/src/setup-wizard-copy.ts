...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    beta: 'Beta',
    title: 'Set up AdvanceMind',
    profile: 'Profile',
    welcomeTitle: 'Welcome to AdvanceMind',
    ...
    communityMarketBody: 'The open market built into AdvanceMind, including custom data sources.',
    ...
    startUsing: 'Start using AdvanceMind',
  ...
  zh: {
    ...
    beta: 'Beta',
    title: '设置 AdvanceMind',
    profile: 'Profile',
    welcomeTitle: '欢迎使用 AdvanceMind',
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'AdvanceMind 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
