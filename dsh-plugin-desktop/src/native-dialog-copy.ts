...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    hostStoppedInstructions: 'Open windows can no longer reach it, and no work is lost on disk. Restart AdvanceMind to reconnect, or open DSH Terminal to inspect the logs first.',
    openTerminal: 'Open DSH Terminal',
    restart: 'Restart AdvanceMind',
    dismiss: 'Dismiss',
    updateAvailableTitle: 'AdvanceMind Update Available',
    updateAvailableMessage: version => `AdvanceMind ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    installStableAlongsideBeta: 'Install the stable edition alongside AdvanceMind Beta? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'Could not retrieve update information.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'AdvanceMind Is Up to Date',
    ...
    updateDownloadedTitle: 'AdvanceMind Update Downloaded',
    updateReady: version => `AdvanceMind ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace AdvanceMind in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart AdvanceMind and run the installer now?',
    ...
    updateInstalled: version => `AdvanceMind ${version} has been installed.`,
  ...
  zh: {
    ...
    hostStoppedInstructions: '已打开的窗口无法再与它通信，磁盘上的内容不会丢失。重启 AdvanceMind 即可重新连接；也可以先打开 DSH 终端查看日志。',
    openTerminal: '打开 DSH 终端',
    restart: '重启 AdvanceMind',
    dismiss: '关闭',
    updateAvailableTitle: 'AdvanceMind 有可用更新',
    updateAvailableMessage: version => `AdvanceMind ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？AdvanceMind Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: '未能获取更新信息。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'AdvanceMind 已是最新版本',
    upToDateMessage: '当前已是最新版本。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '当前版本不支持在应用内下载安装包。',
    updateDownloadedTitle: 'AdvanceMind 更新已下载',
    updateReady: version => `AdvanceMind ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 AdvanceMind，然后重新打开。',
    windowsInstallQuestion: '现在重启 AdvanceMind 并运行安装程序？',
    ...
    updateInstalled: version => `AdvanceMind ${version} 已安装。`,
