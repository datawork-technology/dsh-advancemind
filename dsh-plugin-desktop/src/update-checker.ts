/** Headless version checks against the public AdvanceMind release service. */
...
/** Public endpoint returning the latest AdvanceMind version for a requested channel. */
...
/**
 * Check the fixed AdvanceMind version endpoint for a release in one channel.
